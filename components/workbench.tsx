...
// Get WIP projects from config - prioritize featured/in-progress projects
const getWipItems = () => {
  const projects = portfolioConfig.projects || [];

  // Filter and format projects for workbench display
  // Prioritize projects that are not fully complete (can use status field or show recent ones)
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 sm:mb-14 space-y-3 animate-fade-in-up">
          ...
          <p className="max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
            Active experiments and shipped projects. Things I&apos;m building
            and maintaining.
          </p>
        </div>
